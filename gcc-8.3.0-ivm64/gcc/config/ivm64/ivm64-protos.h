...
extern void ivm64_output_cbranch_multimode(rtx *operands, machine_mode mode);
extern void ivm64_output_cbranch_multimode_peep(rtx *operands, machine_mode mode, int reverse);
