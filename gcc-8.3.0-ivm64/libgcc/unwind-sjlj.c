...
/* ivm64 */
#ifdef __ivm64__
    // ivm sj/lj supported in newlib 
    typedef struct {unsigned long fp; unsigned long pcret; unsigned long sp; unsigned long unused[2]; unsigned long extra[16];} jmp_buf[1];
